...
public class SignUpapp extends AppCompatActivity {
    ...
    String NAME,AGE,EMAIL,PASSWORD,PASSWORD_HINT;
    ...
    public  void get_user_register_filled_data(){
        EditText user_register_name,user_register_age,user_register_email,user_register_password,user_register_password_hint;
    ...
    public void create_user_and_store_firebase(String name,String age,String email,String password, String password_hint){
        FirebaseFirestore fb = FirebaseFirestore.getInstance();
        String uid = fb.collection("USERS").document().collection(name).document().getId();
        Users user = new Users(name,age,email,password,password_hint,uid);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            create_user_and_store_firebase(NAME, AGE, EMAIL, PASSWORD, PASSWORD_HINT);
                        } else {
